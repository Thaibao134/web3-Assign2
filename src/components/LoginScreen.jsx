...
const LoginScreen = () => {
    ...
    return (
        ...
        <button onClick={handleSignintoGallery}>Gallery</button>
        <button onClick={handleSignintoArtist}>Artist</button>
        ...
        <div class="px-6 py-4">
            ...
            <form>
                ...
                <div class="flex items-center justify-between mt-4">
                    ...
                    <button class="px-6 py-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50" onClick={handleSignin}>
                        Sign In
                    </button>
                </div>
            </form>
